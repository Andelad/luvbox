...
// Material icons (you'll need to replace these with your own icons or install a library like @material-ui/icons)
// For now, we'll use simple inline SVGs
const icons = {
  cube: (
      ...
      <div className="sidebar-header">
        <div className="logo-container">
          <NavLink to="/" className="logo-link">
            <img src={logo} alt="LuvBox Logo" className="sidebar-logo" />
